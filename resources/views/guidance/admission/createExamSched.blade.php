                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href='/guidance/view_examsched/{{$sched->id}}'>Modify</a> | <!--<a href='/guidance/delete_examsched/{{$sched->id}}'>Deactivate</a> |--> <a href="/guidance/viewbatch/{{$sched->id}}">View List</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
