...
<tbody>
    ...
    <tr>
        ...
        <td><a href='/guidance/view_examsched/{{$sched->id}}'>Modify</a> | <a href='/guidance/delete_examsched/{{$sched->id}}'>Delete</a> | <a href="/guidance/viewbatch/{{$sched->id}}">View List</a></td>
    </tr>
    @endforeach
</tbody>
</table>