...
<script>
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/tesda/getlist/" + program_code + "/" + curriculum_year + "/" + period + "/" + level,
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/tesda/getcourseoffered/" + program_code + "/" + curriculum_year + "/" + period + "/" + level + "/" + section,
            success: function (data) {
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/tesda/getsubject/" + program_code + "/" + curriculum_year + "/" + period + "/" + level + "/" + section + "/" + course_code,
            success: function (data) {
            $('#course_offered').html(data);
            }
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/tesda/removesubject/" + id,
            data: array,
            success: function (data) {
            $('#course_offered').html(data);
            }
    ...
    $.ajax({
    type: "GET",
    url: "/registrar/ajax/tesda/addallsubjects",
    data: array,
            success: function (data) {
            $('#course_offered').html(data);
            }
