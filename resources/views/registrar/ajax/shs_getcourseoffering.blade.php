...
<tbody>
    <?php
    $lists = DB::select("select * from course_offerings where track='$track' and section=$section->section and period = '$school_year->period' and level='$level' and school_year = '$school_year->school_year'");
    ?>
