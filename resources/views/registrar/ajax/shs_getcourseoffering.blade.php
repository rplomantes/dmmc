...
<tbody>
    <?php
    $lists = DB::select("select * from course_details_shs where track='$track' and section='$section->section' and level='$level' and school_year = '$school_year->school_year' order by `period`");
    ?>
