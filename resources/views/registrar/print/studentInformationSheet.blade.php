...
<table class='tablec' width='100%'>
    ...
    <tr>
        <td style="border-collapse: collapse; border: 1px solid black; text-align: left;" colspan="3">&nbsp; @if ($student_info->address==null)<br> @else{{$student_info->address}}@endif<p class="ps">&nbsp; ADDRESS</p></td>
