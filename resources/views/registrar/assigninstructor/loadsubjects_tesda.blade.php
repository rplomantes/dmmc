...
$courses = \App\CourseOffering::distinct()->where('school_year', $school_year->school_year)->where('period', $school_year->period)->where('program_code','BES-NCII')->get(['program_code']);
?>
...
<script>
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/get_courseoffering_tesda",
            data: array,
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/add_coursetoinstructor_tesda/" + id,
            data: array,
            success: function (data) {
    ...
    $.ajax({
    type: "GET",
            url: "/registrar/ajax/remove_coursetoinstructor_tesda/" + id,
            data: array,
            success: function (data) {
            $('#existingloads').html(data);
            loadcourseoffering()
