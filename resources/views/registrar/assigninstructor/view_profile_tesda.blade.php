    ...
    <div class='col-sm-12'>
        <div id="imaginary_container">
            ...
            @endif
                ...
                <tr>
                    <td><a href="{{url('registrar', array('assign_instructor', 'modify_tesda', $instructor->id))}}"><div class="col-sm-12 btn btn-success">Modify</div></a></td>
                    <td><a href="{{url('registrar', array('assign_instructor', 'loadsubjects_tesda', $instructor->id))}}"><div class="col-sm-12 btn btn-primary">Load Subjects</div></a></td>
                </tr>
            </table>
        </div>
    </div>
