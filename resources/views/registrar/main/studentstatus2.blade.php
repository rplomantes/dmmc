...
<div class="row">
    <div class="col-sm-12">
        ...
        <table class='table table-condensed'>
            ...
            <tr>
                @if ($student_status->academic_type!=="Senior High School")
                <td>Course</td>
                <td>{{$student_status->program_name}}</td>
                @else
                <td>Strand</td>
                <td>{{$student_status->track}}</td>
                @endif
            </tr>
        ...
        <div class="row">
            <div class="row bs-wizard" style="border-bottom:0;">
                ...
                <div
                    @if ($student_status->status==1) 
                        class="col-xs-3 bs-wizard-step active" 
                    @elseif ($student_status->status==2 or $student_status->status==3 or $student_status->status==4)
                        class="col-xs-3 bs-wizard-step complete"
                    @else
                ...
                <div
                    @if ($student_status->status==2) 
                        class="col-xs-3 bs-wizard-step active" 
                    @elseif ($student_status->status==3 or $student_status->status==4)
                        class="col-xs-3 bs-wizard-step complete"
                    @else
                        class="col-xs-3 bs-wizard-step"
                    @endif
