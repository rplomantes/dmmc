            ...
            <div class="form form-group">
                <div class="col-sm-4">
                    ...
                    <select id="program_code" class="form form-control">
                        ...
                        <option value="{{$program_code->track}}">{{$program_code->track}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-4">
...
<script>                
    $("#search").keypress(function(e){
            ...
            $.ajax({
            type:"GET",
                    url:"/registrar/ajax/studentlist/getsubjectlistpersearchshs",
                    data:array,
    ...
    function getsubjectlist(){
        ...
        $.ajax({
            type: "GET",
            url: "/registrar/ajax/studentlist/getsubjectlistshs",
            data: array,
            success: function (data) {
                $('#subjectlist').empty();
                $('#subjectlist').html(data);
