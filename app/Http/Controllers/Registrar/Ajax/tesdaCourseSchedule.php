...
class tesdaCourseSchedule extends Controller {
    ...
    function getcourses($program_code) {
        if (Request::ajax()) {
            ...
            return view('registrar.ajax.tesda_getcourses', compact('courses'));
        }
    }
...
//            return view('registrar.ajax.college_getexistingsched', compact('schedules'));
            ...
            return view('registrar.ajax.tesda_getexistingsched', compact('courses', 'school_year', 'period', 'room'));
        }
    }
    ...
    function addschedule() {
        ...
        return view('registrar.ajax.tesda_popsched', compact('schedules'));
        }
    }
