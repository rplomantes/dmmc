...
class tesdaCourseOffering extends Controller {
    ...
    function getList($program_code, $curriculum_year, $period, $level) {
        if (Request::ajax()) {
            ...
            return view('registrar.ajax.tesda_getlist', compact('lists', 'program_code', 'curriculum_year', 'period', 'level'));
        }
    }
    ...
    function getCourseOffered($program_code, $curriculum_year, $period, $level, $section) {
        if (Request::ajax()) {
            ...
            return view('registrar.ajax.tesda_getcourseoffering', compact('sections', 'program_code', 'curriculum_year', 'period', 'level', 'school_year'));
        }
    }
